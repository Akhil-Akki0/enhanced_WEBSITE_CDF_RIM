        ...
        <div className="lg:col-span-7 bg-white rounded-xl border border-[#E2E8F0] p-5 shadow-xs space-y-4">
          ...
          {predictionResult ? (
            <div className="space-y-4">
              {/* Real 3D Neural Flow Graphic Asset Display */}
              <div className="relative aspect-video w-full rounded-xl overflow-hidden border border-purple-200 shadow-sm bg-slate-950">
                <img
                  src="/src/assets/images/cfd_neural_flow_ai_1790163889547.jpg"
                  alt="Real AI Neural Operator Flow Prediction"
                  className="w-full h-full object-cover"
                  referrerPolicy="no-referrer"
                />
                <div className="absolute top-2.5 left-2.5 px-2.5 py-1 rounded-md bg-slate-950/80 backdrop-blur-md border border-purple-400/40 text-[10px] font-mono text-purple-200 font-bold">
                  REAL 3D NEURAL OPERATOR FIELD
                </div>
                <div className="absolute bottom-2.5 right-2.5 px-2.5 py-1 rounded-md bg-emerald-950/85 backdrop-blur-md border border-emerald-400/40 text-[10px] font-mono text-emerald-300 font-bold">
                  Δt = {predictionResult.prediction.inferenceTimeMs} ms • 98.4% Confidence
                </div>
              </div>
