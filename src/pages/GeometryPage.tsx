            ...
            <div className="bg-white/90 backdrop-blur-xs rounded-xl border border-[#BAE6FD]/70 p-3.5 shadow-xs space-y-2.5">
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  {
                    id: 'fsae_wing',
                    label: 'FSAE Racing Wing (STL)',
                    image: '/src/assets/images/cfd_wind_tunnel_vehicle_1790163836534.jpg',
                    badge: 'Ground Effect'
                  },
                  {
                    id: 'airfoil',
                    label: 'Supercritical Wing (OBJ)',
                    image: '/src/assets/images/cfd_transonic_shockwave_1790163852748.jpg',
                    badge: 'Transonic M0.85'
                  },
                  {
                    id: 'propeller',
                    label: 'Drone Propeller (PLY)',
                    image: '/src/assets/images/cfd_vortex_propeller_wake_1790163871792.jpg',
                    badge: 'Helical Tip Vortex'
                  },
                  {
                    id: 'cylinder',
                    label: 'Vortex Tube (VTK)',
                    image: '/src/assets/images/cfd_hero_aerodynamic_render_1790163821497.jpg',
                    badge: 'Karman Shedding'
                  },
                ].map((item) => (
                  <button
                    key={item.id}
                    onClick={() => handleLoadSampleFile(item.id as any)}
                    className="p-2 bg-white hover:bg-sky-50 border border-sky-200 hover:border-sky-500 rounded-xl text-left transition-all cursor-pointer shadow-xs group flex flex-col gap-1.5"
                  >
                    <div className="relative aspect-video w-full rounded-lg overflow-hidden border border-slate-200 bg-slate-900">
                      ...
                      />
                      <span className="absolute bottom-1 right-1 text-[8px] font-mono px-1 py-0.2 rounded bg-slate-900/80 text-cyan-300 font-bold">
                        {item.badge}
                      </span>
                    </div>
                    <span className="text-[11px] font-bold text-slate-800 group-hover:text-sky-700 truncate">
                      {item.label}
                    </span>
                  </button>
                ))}
