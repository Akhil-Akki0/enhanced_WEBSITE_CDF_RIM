...
import { triggerShockwave } from '../components/common/GlobalShockwaveOverlay';
...
export const SimulationRunnerPage: React.FC = () => {
  ...
  const startSimulation = async () => {
    ...
    triggerShockwave(undefined, undefined, 'rgba(6, 182, 212, 0.85)');
    setIsRunning(true);
      ...
      pollTimer = setInterval(async () => {
        try {
          ...
          if (job.status === 'completed') {
            ...
            setIsConverged(true);
            sound.playSuccess();
            triggerShockwave(undefined, undefined, 'rgba(99, 102, 241, 0.9)');
            triggerConfetti();
